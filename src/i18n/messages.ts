...
const vi: typeof en = {
  ...
  btn_download_selected: "Tải quận đã chọn",
  btn_download_all: "Tải toàn TP.HCM",
...
const fr: typeof en = {
  ...
  btn_download_selected: "Telecharger la selection",
  btn_download_all: "Telecharger tout HCMV",
  btn_download_zip: "Telecharger tout en ZIP",
...
const de: typeof en = {
  ...
  btn_include_geojson: "GeoJSON einschliessen",
  btn_download_selected: "Auswahl herunterladen",
  btn_download_all: "Alle HCMC herunterladen",
